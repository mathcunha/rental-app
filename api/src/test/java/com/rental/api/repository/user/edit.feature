Feature: Update/Delete user
  ...
  Scenario: User validation
    ...
    When method POST
    And def location1591810321164 = responseHeaders['Location']
    Then status 201
    ...
    When method POST
    And def location1591810443819 = responseHeaders['Location']
    Then status 201
    ...
    Given path location1591810443819
    And header Authorization = 'Bearer ' + token1591810321164.token
    When method GET
    Then status 403
    ...
    Given path location1591810321164
    And header Authorization = 'Bearer ' + token1591810321164.token
    When method GET
    Then status 200
